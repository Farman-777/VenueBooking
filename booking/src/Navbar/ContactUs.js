      ...
      <div className="card p-5" style={{ boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", borderRadius: "10px", background: "#444", color: "#fff" }}>
        ...
        <form onSubmit={handleFormSubmit}>
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="name" style={{ background: "#fff", color: "#333" }} />
          </div>
          <div className="mb-3">
            <label htmlFor="email" className="form-label">
              Email
            </label>
            <input type="email" className="form-control" id="email" style={{ background: "#fff", color: "#333" }} />
          </div>
          <div className="mb-3">
            <label htmlFor="message" className="form-label">
              Message
            </label>
            <textarea className="form-control" id="message" rows="4" style={{ background: "#fff", color: "#333" }} />
          </div>
